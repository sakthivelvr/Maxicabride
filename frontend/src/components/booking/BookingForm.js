...
export default function BookingForm() {
  ...
  const paymentMethods = [
    {
      _id: "1",
      value: "CARD_PAYMENT",
      name: "CARD PAYMENT - 5% admin charges",
    },
    {
      _id: "2",
      value: "PAYNOW_QR",
  ...
  const vehicleSelectHandler = (vehicle) => {
    ...
    const res = services.filter(
      (service) => service.vehicleCategory === vehicle[0].category
    );
                  ...
                  {/* {cruiseTerminalsStatus && (
                    ...
                    >
                      ...
                      <Select
                        ...
                        onChange={(cruiseTerminal) => cruiseTerminalSelectHandler(cruiseTerminal)}
                      />
                ...
                {fullPriceDetails && (<><div className="form-check-outline mb-2 text-start ps-4">
                  ...
                  <div className="form-check-outline mb-2 text-start ps-4">
                    ...
                    <label className="form-check-label" htmlFor="defaultCheck3">
                      Additional Stop Along the Way $10
                    </label>
                  </div>
                  ...
                  <div className="form-check-outline mb-2 text-start ps-4">
                    ...
                    <label className="form-check-label" htmlFor="defaultCheck4">
                      Additional Stop Out of the Way $20
                    </label>
                  </div>
